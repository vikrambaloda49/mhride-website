...
import { FileText, Calendar, MapPin, Mail } from 'lucide-react';
import {
  TermsData,
  lastUpdated,
  effectiveDate,
...
const termsData: TermsSection[] = TermsData;
...
const Terms = () => {
  ...
  return (
    <div className="min-h-screen bg-white ">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10 py-20 lg:py-32 relative z-10">
          <div className="text-center">
            ...
            <p className="text-2xl lg:text-3xl text-gray-600 mb-12 leading-relaxed max-w-4xl mx-auto font-light">
              Legal terms and conditions for using <span className="text-red-600 font-medium">MHride</span> services in Canada and Alberta
            </p>
            
            {/* Info cards with similar styling to Hero stats */}
      ...
      {/* Footer Contact Section - Similar to Hero CTA style */}
      <div className="bg-gray-900 text-white py-20 lg:py-32 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-12 text-center relative z-10">
          <h2 className="text-5xl lg:text-6xl xl:text-7xl font-black mb-8 leading-tight">
            Questions About
            <br />
            <span className="text-red-500">These Terms?</span>
          </h2>
          
          <p className="text-2xl lg:text-3xl text-gray-300 mb-16 leading-relaxed font-light max-w-3xl mx-auto">
            Contact our legal team for clarification or assistance with any questions you may have
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16 max-w-2xl mx-auto">
            <div className="group">
              ...
              <p className="text-sm text-gray-400 uppercase tracking-wider mb-2">Email Support</p>
              <a 
            ...
            <div className="group">
              <div className="flex justify-center mb-4 p-4 bg-blue-600/10 rounded-2xl w-fit mx-auto group-hover:bg-blue-600/20 transition-colors">
                <MapPin className="w-8 h-8 text-blue-400" />
              </div>
              <p className="text-sm text-gray-400 uppercase tracking-wider mb-2">Registered Office</p>
              <p className="text-2xl font-bold">{companyInfo.registeredOffice}</p>
            </div>
          </div>
